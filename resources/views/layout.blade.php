...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.61">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.61">
    <script>
                ...
                <div class="patient inline-block">
                    <div class="form-login">
                        ...
                        <div class="padding-bottom-10">
                            <a href="javascript:void(0)" class="facebook-custom-btn social-login-btn calibri-regular fs-20" data-url="//api.dentacoin.com/api/login" data-platform="dentacoin" @if(isset($inviter)) data-inviter="{{$inviter}}" @endif data-type="patient">with Facebook</a>
                        </div>
                        <div>
    ...
    <script type='application/ld+json'>
{
  ...
  "aggregateRating": {
    ...
    --}}<script src="/dist/js/front-libs-script.js?v=1.0.61"></script>
    @yield("script_block")
    <script src="/dist/js/front-script.js?v=1.0.61"></script>
