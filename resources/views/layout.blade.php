...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.78">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.78">
    <script>
    ...
    <script type='application/ld+json'>
{
  ...
  "aggregateRating": {
    ...
    --}}<script src="/dist/js/front-libs-script.js?v=1.0.78"></script>
    @yield("script_block")
    <script src="/dist/js/front-script.js?v=1.0.78"></script>
