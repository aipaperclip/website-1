...
<body data-current="one" class="@if(!empty(Route::current())) {{Route::current()->getName()}} @else class-404 @endif @if(!empty(Route::current()) && ((Route::current()->getName() == 'careers' && empty(request()->route()->parameters) || Route::current()->getName() == 'corporate-design'))) allow-draw-lines @endif">
...
@endif
    ...
    <script src="https://emailoctopus.com/bundles/emailoctopuslist/js/1.3/recaptcha.js?1542713735"></script>
    @yield("script_block")
    <script src="/dist/js/front-script.js?v=1.0.16"></script>
