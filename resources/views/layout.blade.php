...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.1.12">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.1.12">
...
<body data-current="one" class="@if((new \App\Http\Controllers\UserController())->checkSession()) logged-in @if((new \App\Http\Controllers\UserController())->checkPatientSession()) logged-patient @elseif((new \App\Http\Controllers\UserController())->checkDentistSession()) logged-dentist @endif @endif @if(!empty(Route::current())) {{Route::current()->getName()}} @else class-404 @endif">
    ...
    <div class="response-layer">
        <div class="wrapper">
            <picture itemscope="" itemtype="http://schema.org/ImageObject">
                ...
                <img itemprop="contentUrl" src="/assets/uploads/dcn-flipping-coin-logo-loader-V3.gif" class="max-width-250 max-width-xs-200" alt="Loader">
            </picture>
        </div>
    </div>
    @if(!empty($_COOKIE['marketing_cookies']))
    ...
    --}}<script src="/dist/js/front-libs-script.js?v=1.1.12"></script>
    ...
    @endif
    @yield("script_block")
    <script src="/dist/js/front-script.js?v=1.1.12"></script>
