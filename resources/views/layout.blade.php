        ...
        <div class="container">
            ...
            <div class="row socials">
                <div class="col-xs-12" itemscope="" itemtype="http://schema.org/Organization">
                    ...
                    <ul>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="mailto:admin@dentacoin.com" aria-label="Mail"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/mail-icon.svg') }}" itemprop="contentUrl" alt="Mail icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://t.me/dentacoin" aria-label="Telegram"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/iconmonstr-telegram.svg') }}" itemprop="contentUrl" alt="Telegram logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://www.facebook.com/dentacoin/" aria-label="Facebook"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/facebook.svg') }}" itemprop="contentUrl" alt="Facebook logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://twitter.com/dentacoin" aria-label="Twitter"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/twitter.svg') }}" itemprop="contentUrl" alt="Twitter logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://www.instagram.com/dentacoin_official/" aria-label="Instragram"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/instagram.svg') }}" itemprop="contentUrl" alt="Instragram logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://www.youtube.com/dentacoin" aria-label="Youtube"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/youtube-play-button.svg') }}" itemprop="contentUrl" alt="Youtube play button icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://github.com/Dentacoin" aria-label="Github"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/github.svg') }}" itemprop="contentUrl" alt="Github logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://www.reddit.com/r/Dentacoin/" aria-label="Reddit"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/reddit.svg') }}" itemprop="contentUrl" alt="Reddit logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://medium.com/@dentacoin/" aria-label="Medium"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/medium-m.svg') }}" itemprop="contentUrl" alt="Medium logo icon"/></figure></a></li>
                        <li class="inline-block"><a itemprop="sameAs" target="_blank" href="https://steemit.com/@dentacoin" aria-label="Steemit"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="{{URL::asset('assets/images/steemit.svg') }}" itemprop="contentUrl" alt="Steemit logo icon"/></figure></a></li>
                    </ul>
                </div>
            </div>
            <div class="row menu">
