...
<div class="dentacoin-login-gateway-fs-0 popup-header-action">
    <a href="javascript:void(0)" class="inline-block @if($type == 'patient-login' || $type == 'patient-register') gateway-platform-background-color-important active @endif" data-type="patient">{{$translations['users-tab']}}</a>
    <a href="javascript:void(0)" class="inline-block init-dentists-click-event @if($type == 'dentist-login' || $type == 'dentist-register' || $type == 'incompleted-dentist-register') active @endif" data-type="dentist">{{$translations['dentists-tab']}}</a>
</div>
    ...
    <div class="patient inline-block gateway-platform-background-color @if($type == 'dentist-login' || $type == 'dentist-register' || $type == 'incompleted-dentist-register') custom-hide @endif">
        <div class="form-login @if($type == 'patient-register' || $type == 'dentist-register' || $type == 'incompleted-dentist-register') display-none @endif">
            ...
            <div class="form-login-fields">
                ...
                <div>
                    <a href="javascript:void(0)"  class="civic-custom-btn social-login-btn calibri-regular dentacoin-login-gateway-fs-20" data-url="//api.dentacoin.com/api/login" data-platform="" @if(isset($inviter)) data-inviter="{{$inviter}}" @endif>Continue with Civic</a>
                </div>
                <div class="have-old-account text-center">Have an old profile with email and password? <a href="mailto:admin@dentacoin.com">Contact us</a>
                </div>
        ...
        <div class="form-register @if($type == 'patient-login' || $type == 'dentist-login') display-none @endif">
            ...
            <div>
                <a href="javascript:void(0)"  class="civic-custom-btn social-login-btn calibri-regular dentacoin-login-gateway-fs-20" data-url="//api.dentacoin.com/api/register" data-platform="" @if(isset($inviter)) data-inviter="{{$inviter}}" @endif custom-stopper="true">Continue with Civic</a>
            </div>
                ...
                <div class="step fourth @if(!empty($currentActiveStep) && $currentActiveStep == 'fourth') visible @endif" data-step="fourth">
                    <div class="padding-bottom-20 dentacoin-login-gateway-fs-0">
                        <div class="inline-block-top avatar module upload-file">
                            ...
                            <div class="avatar-name"><span class="dcn-gateway-gray-color"></span><button class="destroy-croppie">×</button></div>
