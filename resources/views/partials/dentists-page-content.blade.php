<section class="section-the-era-dentist-page hide-on-map-open">
    <div class="absolute-content padding-bottom-50 padding-bottom-xs-25 text-center-xs">
        ...
        <h3 class="fs-46 fs-md-40 fs-sm-30 fs-xs-22 lato-black color-black padding-top-10 padding-bottom-25">The era of<br class="hide-xs"> “drill-and-fill”<br class="hide-xs"> dentistry is over.</h3>
