    ...
    <div class="row benefits-row">
        <div class="col-xs-12 text-center fs-0">
            <div class="single-benefit inline-block-top">
                ...
                @else
                    <div itemprop="video" itemscope="" itemtype="http://schema.org/VideoObject" class="video max-width-220 margin-0-auto changeable-video" data-mp4="/assets/uploads/dentists-circle-icon1.webm" data-webm="/assets/uploads/dentists-circle-icon1.mp4" data-video-attributes="muted">
