<div class="text-center padding-top-30 enrich-profile-container" data-type="clinic">
    ...
    <h2 class="lato-bold fs-30">CLINIC PROFILE VERIFICATION</h2>
    <div class="padding-top-20 padding-bottom-15 fs-20">Thank you for submitting your registration form! Our onboarding team will now assess the data you provided to ensure that it represents a real clinic.</div>
    <div class="padding-bottom-25 fs-20 {{--border-bottom--}}">You will receive an email as soon as the verification process is completed.</div>
    ...
    <form method="POST" id="enrich-profile">
        <div class="form-row">
            ...
            <div class="fs-14 calibri-light">This will make your profile stand out and improve your positions in Google.</div>
        </div>
