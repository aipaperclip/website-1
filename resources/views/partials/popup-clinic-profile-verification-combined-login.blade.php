<div class="text-center padding-top-30 enrich-profile-container" data-type="clinic">
    ...
    <h2 class="lato-bold dentacoin-login-gateway-fs-30">CLINIC PROFILE VERIFICATION</h2>
    ...
    <div class="padding-bottom-25 dentacoin-login-gateway-fs-20 {{--border-bottom--}}">You will receive an email as soon as the verification process is completed.</div>
