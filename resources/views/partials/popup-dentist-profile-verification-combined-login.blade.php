<div class="text-center padding-top-30 enrich-profile-container" data-type="dentist">
    ...
    <h2 class="lato-bold dentacoin-login-gateway-fs-30">DENTIST PROFILE VERIFICATION</h2>
    ...
    <div class="padding-bottom-25 dentacoin-login-gateway-fs-20 {{--border-bottom--}}">You will receive an email notification as soon as the verification process is completed.</div>
    <h2 class="lato-bold dentacoin-login-gateway-fs-30 padding-top-25 padding-bottom-25 lato-bold dentacoin-login-gateway-fs-30">While waiting, why don’t you enrich your profile?</h2>
