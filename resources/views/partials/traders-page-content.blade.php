<section class="section-bringing-blockchain-solutions-trader-page">
    <div class="absolute-content padding-bottom-50 padding-bottom-xs-15 text-center-xs">
        <h2 class="fs-50 fs-md-40 fs-sm-30 color-white lato-black users-title padding-bottom-lgll-20 hide-xs">TRADERS</h2>
        <h3 class="fs-50 fs-md-40 fs-sm-30 fs-xs-22 lato-black color-white padding-top-10 padding-bottom-25">Bringing Blockchain solutions to the masses.</h3>
    ...
    @if ($arrWithPossibilities[rand(0, count($arrWithPossibilities) - 1)] == 'male')
        <figure class="hidden-picture" itemscope="" itemtype="http://schema.org/ImageObject">
            <img alt="Trader animated background" class="trader-animated-background" itemprop="contentUrl" src="/assets/uploads/trader-monitors-animation.gif" />
            <img alt="Male dentacoin trader" class="trader" itemprop="contentUrl" src="/assets/uploads/man-trader-mobile-img.png" />
        </figure>
    @else
        <figure class="hidden-picture" itemscope="" itemtype="http://schema.org/ImageObject">
            <img alt="Trader animated background" class="trader-animated-background" itemprop="contentUrl" src="/assets/uploads/trader-monitors-animation.gif" />
            <img alt="Female dentacoin trader" class="trader" itemprop="contentUrl" src="/assets/uploads/woman-trader-mobile-img.png" />
        </figure>
    @endif
</section>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 exchanges-container @if($mobile_device) mobile-exchanges @endif padding-left-50 padding-right-50">
                    <div class="row fs-0">
                        ...
                        @if($mobile_device)
                            ...
                            @foreach ($exchange_platforms as $exchange_platform)
                                ...
                                @if ($showOnce)
                                    @php($showOnce = false)
                                    <div class="mobile-extra-row active" data-bullet="{{$exchangeCounter}}">
                                        @php(array_push($bulletsArray, $exchangeCounter))
                                        @endif
                                        <div class="col-xs-6 col-md-4 col-lg-2 inline-block-top padding-bottom-50 single-exchange">
                                            <a href="{{$exchange_platform->link}}" target="_blank" class="exchange-link text-center lato-bold display-block padding-bottom-10">
                                            ...
                                            @if(sizeof($pairs) > 0)
                                                <ul class="lato-semibold fs-16 padding-top-10">
                                                    @foreach($pairs as $pair)
                                                        <li class="padding-bottom-5"><a href="{{$pair->url}}" target="_blank" class="display-block padding-left-15 padding-right-15">{{$pair->title}}</a></li>
                                                    @endforeach
                                                </ul>
                                            @endif
                                        </div>
                    ...
                    @if(sizeof($exchange_platforms) != $exchangeCounter)
                        <div class="mobile-extra-row" data-bullet="{{$exchangeCounter}}">
                            @php(array_push($bulletsArray, $exchangeCounter))
                            @endif
                            @endif
                            @endif
            ...
            <div class="row disclaimer padding-top-25">
                <div class="col-xs-12 text-center color-black fs-16">
                    <div class="inline-block padding-left-60 padding-left-xs-0 padding-top-xs-60 text-content text-left">
                        <div><span class="lato-black">Disclaimer</span>: Exchange platforms are third parties. Choose where to trade at your own risk.</div>
                        <div>And remember: It is always better to store your DCN tokens in a wallet where you own your private key.</div>
                    </div>
                </div>
            </div>
        </div>
...
@endif
<section class="section-rules-and-figures container-fluid padding-top-lgll-80 padding-top-30 padding-bottom-30 padding-left-50 padding-right-50">
    <div class="row">
    ...
    <div class="row fs-0">
        <div class="col-xs-12 col-md-6 col-lg-5 col-lg-offset-1 padding-bottom-50">
            <figure class="max-width-60 inline-block-top" itemscope="" itemtype="http://schema.org/ImageObject">
                <img alt="Max supply icon" itemprop="contentUrl" class="width-100" src="/assets/uploads/max-supply-icon.svg" />
            </figure>
        ...
        <div class="col-xs-12 col-md-6 col-lg-5 padding-bottom-50">
            <figure class="max-width-60 inline-block-top" itemscope="" itemtype="http://schema.org/ImageObject">
                <img alt="Unlocked supply icon" itemprop="contentUrl" class="width-100" src="/assets/uploads/total-unlocked-icon.svg" />
            </figure>
            <div class="right-to-image inline-block-top padding-left-15 lato-bold">
        ...
        <div class="col-xs-12 col-md-6 col-lg-5 col-lg-offset-1 padding-bottom-50">
            <figure class="max-width-60 inline-block-top" itemscope="" itemtype="http://schema.org/ImageObject">
                <img alt="Locked supply icon" itemprop="contentUrl" class="width-100" src="/assets/uploads/locked-icon.svg" />
            </figure>
            <div class="right-to-image inline-block-top padding-left-15 lato-bold">
                <h4 class="fs-28 fs-xs-22 color-black padding-bottom-10">Partly Locked:</h4>
                <div class="fs-20 lato-regular">Approx. 70% of the total supply is locked in TimeLock contracts and is being released in minor parts at the beginning of each year.
                    <div><a href="" target="_blank" class="lato-bold color-bright-blue">See all TimeLock contract addresses.</a></div>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-5 padding-bottom-50">
            <figure class="max-width-60 inline-block-top" itemscope="" itemtype="http://schema.org/ImageObject">
                <img alt="Coin burn icon" itemprop="contentUrl" class="width-100" src="/assets/uploads/burned-icon.svg" />
            </figure>
            <div class="right-to-image inline-block-top padding-left-15 lato-bold">
                <h4 class="fs-28 fs-xs-22 color-black padding-bottom-10">Coin Burn Sessions:</h4>
                <div class="fs-20 lato-regular">The excessive amount of DCN supply is being gradually burned to destroy the coins that are not demanded.
                    <div><a href="" target="_blank" class="lato-bold color-bright-blue">See all coin burn sessions.</a></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-everything-you-need-to-know container padding-top-30 padding-top-lgll-80 padding-bottom-30">
    ...
    <div class="row middle-animated-subsection padding-top-20 padding-bottom-20">
        <figure class="left-animated-border" itemscope="" itemtype="http://schema.org/ImageObject">
            <img alt="Animated border" itemprop="contentUrl" src="/assets/uploads/left-animated-border.png" />
        </figure>
        <figure class="right-animated-border" itemscope="" itemtype="http://schema.org/ImageObject">
            <img alt="Animated border" itemprop="contentUrl" src="/assets/uploads/right-animated-border.png" />
        </figure>
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 fs-22 fs-xs-18 padding-bottom-40">Dentacoin’s target audience extends far beyond the narrow blockchain community, creating a solid bridge towards everyday life and existing business environments.</div>
    </div>
...
@if (!empty($roadmap_years))
    <section class="section-dentacoin-roadmap padding-top-80 padding-top-xs-20 padding-top-lgll-110 padding-bottom-30">
            ...
            <div class="row">
                <div class="col-xs-12 padding-left-xs-5 padding-right-xs-5 text-center fs-0 years-wrapper">
                    @foreach ($roadmap_years as $roadmap_year)
                        ...
                        <a href="javascript:void(0);" data-year="{{$roadmap_year->year}}" class="lato-bold inline-block fs-20 fs-xs-16 @if($roadmap_year->year == date('Y')) active @endif">{{$roadmap_year->year}}</a>
                    @endforeach
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-lg-7 col-lg-offset-2 padding-bottom-30 padding-top-lgll-20">
                    @foreach ($roadmap_years as $roadmap_year)
                        @if (!empty($roadmap_year['roadmap_year_events']))
                            <div class="single-year-content @if($roadmap_year->year == date('Y')) active @endif" data-year="{{$roadmap_year->year}}">
                                <ul>
                                    @foreach ($roadmap_year['roadmap_year_events'] as $event)
                                        <li @if(filter_var($event->bottom_border, FILTER_VALIDATE_BOOLEAN)) class="border-bottom-bright-blue" @endif>
                                            <div class="label-tag inline-block text-right fs-20 fs-xs-16">
                                                <span class="label-btn" style="background-color: {{$event->label_color}}">{{$event->label}}</span>
                                            </div>
                                            <div class="title inline-block padding-left-10 padding-left-xs-5 padding-right-10 padding-right-xs-0 fs-20 fs-xs-16">
                                                @if(filter_var($event->coin_burn, FILTER_VALIDATE_BOOLEAN))
                                                    <svg version="1.1" id="Layer_1" xmlns:x="&amp;ns_extend;" xmlns:i="&amp;ns_ai;" xmlns:graph="&amp;ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 69.8 85.2" style="enable-background:new 0 0 69.8 85.2;width: 25px;margin-right: 10px;vertical-align: middle;" xml:space="preserve"><metadata><sfw xmlns="&amp;ns_sfw;"><slices></slices><slicesourcebounds bottomleftorigin="true" height="85.2" width="69.8" x="11.8" y="31.1"></slicesourcebounds></sfw></metadata><g><path style="fill:none;" d="M43.4,42.2c-1.7,0-3,1.4-3,3.1c0,1.1,0.6,2.1,1.5,2.6v5.1c0,0.9,0.7,1.6,1.5,1.6c0.8,0,1.5-0.7,1.5-1.6v-5.1c0.9-0.5,1.5-1.5,1.5-2.6C46.5,43.6,45.1,42.2,43.4,42.2z"></path><path style="fill:none;" d="M43.4,24.9c-4,0-7.3,3.4-7.3,7.5v5.7c2.4-0.5,4.8-0.8,7.3-0.8c2.5,0,4.9,0.3,7.3,0.8v0l-1-0.3l1,0.3v-5.7C50.7,28.2,47.4,24.9,43.4,24.9z"></path><path style="fill:#FFFFFF;" d="M51.1,38.1c-2.4-0.5-4.8-0.8-7.3-0.8c-2.5,0-4.9,0.3-7.3,0.8v-5.7c0-4.1,3.3-7.5,7.3-7.5c2.4,0,4.6,1.2,6,3.2c0.4,0.6,0.6,1.2,0.9,1.8c0.3,0.7,0.6,1.7,1.4,1.9c0.7,0.2,1.6,0,2.1-0.6c0.8-0.9,0.4-2.1,0-3c-0.9-2-2.2-3.8-4-5.1c-1.9-1.4-4.1-2.1-6.4-2.1c-6.1,0-11.1,5.1-11.1,11.4v6.8c-0.6,0.2-1.1,0.4-1.7,0.6c-0.5,0.2-0.9,0.7-0.9,1.3v14.5c0,0.6,0.4,1.2,0.9,1.4c4.1,1.7,8.4,2.5,12.8,2.5c4.4,0,8.7-0.8,12.8-2.5c0.5-0.2,0.9-0.8,0.9-1.4c0,0,0-14.5,0-14.5c0-0.6-0.4-1.1-0.9-1.3c-0.2-0.1-0.5-0.2-0.7-0.3c-0.3-0.1-0.7-0.3-1-0.4l-2-0.6 M45.4,47.9v5.1c0,0.9-0.7,1.5-1.5,1.5c-0.8,0-1.5-0.7-1.5-1.5v-5.1c-0.9-0.5-1.5-1.5-1.5-2.6c0-1.7,1.4-3.1,3-3.1c1.7,0,3,1.4,3,3.1C46.9,46.4,46.2,47.4,45.4,47.9z"></path></g><path d="M51.1,31.4C49.8,19.2,38.8,4,28.8,0c1.8,9.6-2.3,21.3-15.4,39.1c0.1-1.3,0.5-8-3.2-14c1,6.8-8.5,18.8-9.9,31.1s6.8,22,19.3,29.1h0.4C10.3,72.6,23.2,53.3,32,49.3c-2.5,6.1,2.7,15.2,6.1,17.2c-1.6-5.1,0.8-7.8,2-9.1c0.7,9.8,15.4,13.1,8.2,27.2c10.7-6.3,18-16,20.7-26.1c2.7-10.3-1.7-27.8-16.4-42.5C54.2,18.4,56.1,27.5,51.1,31.4z"></path></svg>
                                                @endif
                                                {!! $event->title !!}
                                            </div>
                                            <div class="check inline-block">
                                                @if(filter_var($event->check, FILTER_VALIDATE_BOOLEAN))
                                                    <figure itemscope="" itemtype="http://schema.org/ImageObject">
                                                        <img alt="Checked icon" itemprop="contentUrl" class="width-100 max-width-40 max-width-xs-30" src="/assets/uploads/roadmap-checked-icon.svg" />
                                                    </figure>
                                                @else
                                                    <figure itemscope="" itemtype="http://schema.org/ImageObject">
                                                        <img alt="Unchecked icon" itemprop="contentUrl" class="width-100 max-width-40 max-width-xs-30" src="/assets/uploads/roadmap-not-checked-icon.svg" />
                                                    </figure>
                                                @endif
                                            </div>
                                        </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center">
                <h2 class="lato-bold fs-30 fs-sm-24 fs-xs-20 padding-bottom-lgll-10 padding-bottom-5">MANAGE, SPEND, RECEIVE, AND BUY DCN</h2>
                ...
                <div class="padding-top-25 padding-top-lgll-40 padding-bottom-10 text-center">
                    <a href="https://play.google.com/store/apps/details?id=wallet.dentacoin.com" target="_blank" class="inline-block padding-left-10 padding-right-10 padding-bottom-10">
                        <img src="/assets/uploads/google-play-badge.svg" class="width-100 max-width-220" alt="Google Play button">
                    </a>
                    <a href="https://apps.apple.com/us/app/dentacoin-wallet/id1478732657" target="_blank" class="inline-block padding-left-10 padding-right-10 padding-bottom-10">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-0 padding-top-40 padding-top-xs-10">
                <figure itemscope="" itemtype="http://schema.org/ImageObject" class="laptop-phone-holder">
                    <img alt="Dentacoin wallet app on laptop" class="laptop" itemprop="contentUrl" src="/assets/uploads/laptop-wallet-app-banner.png"/>
                    <img alt="Dentacoin wallet app on phone" class="phone" itemprop="contentUrl" src="/assets/uploads/phone-wallet-app-banner.png"/>
                </figure>
            </div>
        </div>
    </div>
