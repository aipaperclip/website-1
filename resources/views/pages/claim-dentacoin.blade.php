        ...
        <div class="container padding-top-50">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-xs-12 col-md-8 col-md-offset-2 text-center">
                    ...
                    <div class="padding-top-30 padding-bottom-40 fs-28 lato-black">You can claim: <img src="/assets/images/logo.svg" class="width-100 inline-block max-width-30" alt="Dentacoin logo"/> <span>{{$amount}}</span></div>
