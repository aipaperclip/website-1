                ...
                <div class="row">
                    <div class="col-xs-12 col-md-10 col-md-offset-1 fs-0">
                        <figure class="inline-block" itemscope="" itemtype="http://schema.org/ImageObject"><img
                                    ...
                                    src="https://dentacoin.com/assets/uploads/flipping-coin-logo.gif"></figure>
    ...
    <div class="corporate-design-container">
        <section>
            <div class="container">
                ...
                <div class="row padding-left-40 padding-right-40 padding-bottom-70 clickable-squares-row">
                    <div class="col-xs-12 col-lg-10 col-lg-offset-1"><a class="square border active" href="javascript:void(0)" style="background-color: #ffffff;"><span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 255 255 255<br>HEX: #ffffff<br>CMYK: 0 0 0 0 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #f2f2f2;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 242 242 242<br>HEX: #f2f2f2<br>CMYK: 4 2 2 0 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #e6e6e6;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 230 230 230<br>HEX: #e6e6e6<br>CMYK: 9 6 7 0 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #d3ebfb;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 211 235 251<br>HEX: #d3ebfb<br>CMYK: 4 2 2 0 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #36c0ff;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 54 192 255<br>HEX: #36c0ff<br>CMYK: 60 7 0 0 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #08abe0;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/logo.svg"><br>RGB: 8 171 224<br>HEX: #08abe0<br>CMYK: 72 13 1 0 </span>
                        </a></div>
                </div>
                <div class="row padding-left-40 padding-right-40">
                ...
                <div class="row padding-left-40 padding-right-40 padding-bottom-100 clickable-squares-row white-color">
                    <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                        <a class="square active" href="javascript:void(0)" style="background-color: #000000;"><span class="content"> <img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 0 0 0<br>HEX: #000000<br>CMYK: 75 68 67 90 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #001833;"> <span class="content"><img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 0 24 51<br>HEX: #001833<br>CMYK: 96 83 48 63 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #041e42;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 4 30 66<br>HEX: #041e42<br>CMYK: 100 88 42 51 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #004593;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 0 69 147<br>HEX: #004593<br>CMYK: 100 84 11 1 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #126585;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 18 101 133<br>HEX: #126585<br>CMYK: 91 54 32 9 </span>
                        </a>
                        <a class="square" href="javascript:void(0)" style="background-color: #004c67;"> <span class="content"> <img alt="Dentacoin logo" src="/assets/images/rounded-logo-white.svg"><br>RGB: 0 76 103<br>HEX: #004c67<br>CMYK: 98 65 40 24 </span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="download-logo-section text-center-xs">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-10 col-md-offset-1 fs-0">
                        <figure class="inline-block" itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Dentacoin logo" itemprop="contentUrl" src="/assets/images/logo.svg"></figure>
