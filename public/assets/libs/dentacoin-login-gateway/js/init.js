if (typeof jQuery == 'undefined') {
    ...
    var dcnGateway = async function(params) {
        var dcnGatewayRequests = {
        ...
        var utils = {
            getGETParameters: function() {
                ...
                return prmstr != null && prmstr != "" ? utils.transformToAssocArray(prmstr) : {};
            },
        ...
        if ((typeof params !== 'object' && params === null) || (!hasOwnProperty.call(params, 'platform') || !hasOwnProperty.call(params, 'forgotten_password_link') || !hasOwnProperty.call(params, 'user_ip'))) {
            ...
            async function showGateway(type) {
                var gatewayHtml = await dcnGatewayRequests.getGatewayHtml(type);
            ...
            console.log(utils.getGETParameters(), 'utils.getGETParameters()');
        }
    }
}