                            ...
                            if (gatewayHtml.success) {
                                if (!loadedSocialLibs) {
                                    ...
                                    if (!loadedCivicLib && !loadedFromMobileApp) {
                                        loadedCivicLib = true;
                                        await $.getScript('https://dentacoin.com/assets/libs/civic-login/civic-combined-login.js?v='+new Date().getTime(), async function() {
                                            // =============================================== FACEBOOK ====================================================
                                            await $.getScript(dcnLibsDomain + '/assets/libs/facebook-login/facebook-combined-login.js?v='+new Date().getTime(), function() {
                                                proceedWithGatewayInit();
                                            });
                                        });
                                    } else {
                                        // =============================================== FACEBOOK ====================================================
                                ...
                                async function proceedWithGatewayInit() {
